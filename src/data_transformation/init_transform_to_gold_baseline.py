...
def build_complete_feat_user_90d(
    ...
    """Calculates all 5 point-in-time 90-day features across a 30-day snapshot matrix."""
    ...
    df_payments_with_date = df_fact_payment.join(
        ...
        col("user_key"), # Will need to map this back to user_id or use OBT user mapping
    ...
    df_playback_feats = df_matrix_base.alias("base") \
        ...
        .agg(
            ...
            avg("obt.duration_watched_seconds").alias("f_user_avg_duration_watched_seconds_90d"),
    ...
    df_payment_feats = df_matrix_base.alias("base") \
        ...
        .groupBy("base.user_id", "base.snapshot_date") \
        .agg(
            avg(col("pay.is_payment_failed")).alias("f_user_payment_fail_rate_90d")
        )
    ...
    return df_playback_feats.alias("p") \
        ...
        .select(
            ...
            col("p.f_user_avg_duration_watched_seconds_90d"),
...
if __name__ == "__main__":
    ...
    print("\n🚀 All Gold layer tables initialized successfully!")
    spark.stop()